...
- [ ] **H2 · R** — filter, then "play matches" (real library)
...
- [ ] **H3 · R** — the jump rail and back-to-top (real library, 246 albums)
...
- [ ] **J1 · R★** — a release of other recordings is not our album
...
- [ ] **J3 · R★** — an edition marker is still normalised
...
- [ ] **J4 · R★** — a credit's typography is not the artist's name
...
- [ ] **J5 · R★** — a label is not part of an album name
...
- [ ] **J7 · R★** — a wordless entry does not end the search
...
- [ ] **J9 · R★** — a refused length is still remembered
  ...
  - expect: no words, but a `length` of about 230 s comes back as the second opinion
  - invariant: that is what feeds the length chip for tracks MusicBrainz does not know
  - evidence: the returned object

- [ ] **J10 · R★** — a repeated length is real data
